            ...
            <form name="contact" method="POST" netlify-honeypot="bot-field" data-netlify="true" action="/thank-you">
                ...
                <div>
                        ...
                        <div>
                            <div className="col-span-6">
                                <input
                                    ...
                                    className="mt-10 w-full border-b-black border-b bg-transparent"
                    ...
                    <div className="px-4 py-2 text-center sm:px-6">
                        <button
                            type="submit"
                            className="bg-black px-20 py-4 w-full text-white hover:bg-black hover:text-white transition-all ease-in"
                        >
                            Submit
                        </button>
                    </div>
